...
**[Read the official documentation →](https://puffball1567.github.io/kinmokusei/)**
...
- An 84/84 implemented Go-equivalent runtime contract registry backed by isolated handwritten-Go differential tests; new accepted runtime features must extend the registry and oracle together.
