...
The registry currently covers **101 of 101** implemented Go-equivalent runtime groups. This is 100% coverage of the registered implemented surface—not line coverage, not a claim that all Go features exist, and not a roadmap-completion percentage.
