...
func TestNumericConstantContexts(t *testing.T) {
	...
	for _, test := range []struct{ name, source, want string }{
		...
		{"constant alias precision", `const n=1e400;const alias=n;`, ""},
		{"runtime alias overflow", `const n=1e400;let alias=n;`, "overflows"},
		...
		{"constant alias index", `const n=2.0;const alias=n;function f(a:int[]):int{return a[alias];}`, ""},
		{"runtime alias index", `const n=2.0;let alias=n;function f(a:int[]):int{return a[alias];}`, "index must be an integer"},
		...
		{"string constant alias", `const text="abc";const alias=text;function f():byte{return alias[3.0];}`, "out of bounds"},
		{"string runtime alias", `let text="abc";const alias=text;function f():byte{return alias[3.0];}`, ""},
