...
func TestSingleInheritanceSemanticMatrix(t *testing.T) {
	...
	invalid := []struct {
		...
		{"projection interface collision", `function __kinmokuseiChildProjection(): void {} class Base {} class Child extends Base {}`, `generated Go name "__kinmokuseiChildProjection" collides`},
		{"projection method collision", `class Base {} class Child extends Base { private function __kinmokuseiAsChild(): Child { return this; } }`, `generated Go struct member name "__kinmokuseiAsChild" collides`},
		{"virtual slot field collision", `class Base { private __kinmokuseiBaseRead: int; constructor() { this.__kinmokuseiBaseRead = 1; } public virtual function read(): int { return 1; } }`, `generated Go struct member name "__kinmokuseiBaseRead" collides`},
	}
