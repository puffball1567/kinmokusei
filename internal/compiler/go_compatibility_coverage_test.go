...
var implementedGoCompatibilityContracts = []string{
	...
	"constructor definite initialization from boolean/integer/string constant expressions, append/makeSlice cardinality, side-effect-free compound length guards, and terminating empty guard clauses",
