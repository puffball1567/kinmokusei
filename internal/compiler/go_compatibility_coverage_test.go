...
var differentialGoCompatibilityScenarios = map[string][]string{
	...
	"source-results.test":                 {implementedGoCompatibilityContracts[0], implementedGoCompatibilityContracts[1], implementedGoCompatibilityContracts[2], implementedGoCompatibilityContracts[16], implementedGoCompatibilityContracts[29]},
