...
var implementedGoCompatibilityContracts = []string{
	...
	"constructor definite initialization from boolean/integer/string constant expressions, append/makeSlice cardinality, side-effect-free compound and nested length guards, terminating empty guard clauses, and length-switch branches",
