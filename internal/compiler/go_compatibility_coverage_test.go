...
var implementedGoCompatibilityContracts = []string{
	...
	"class field initializers with per-instance evaluation, source order, checked reads of earlier and inherited fields, base-before-derived phases, generic types and upcasts, module lexical scope, independent reference state, constructor guarantees, exceptions, and public Go construction",
...
var differentialGoCompatibilityScenarios = map[string][]string{
	...
	"decorator-type-identities.test":      {implementedGoCompatibilityContracts[102]},
	...
	"static-fields.test":                  {implementedGoCompatibilityContracts[101]},
	"class-constants.test":                {implementedGoCompatibilityContracts[101]},
	...
	"generic-array-target.test":           {implementedGoCompatibilityContracts[2], implementedGoCompatibilityContracts[8], implementedGoCompatibilityContracts[9], implementedGoCompatibilityContracts[10], implementedGoCompatibilityContracts[96]},
	"collection-make.test":                {implementedGoCompatibilityContracts[2], implementedGoCompatibilityContracts[8], implementedGoCompatibilityContracts[9], implementedGoCompatibilityContracts[10]},
	"shift-context.test":                  {implementedGoCompatibilityContracts[0], implementedGoCompatibilityContracts[2], implementedGoCompatibilityContracts[5], implementedGoCompatibilityContracts[12]},
	...
	"external-source-packages.test":       {implementedGoCompatibilityContracts[0], implementedGoCompatibilityContracts[2]},
	"generic-slice-builtins.test":         {implementedGoCompatibilityContracts[2], implementedGoCompatibilityContracts[5], implementedGoCompatibilityContracts[9]},
	...
	"collection-results.test":             {implementedGoCompatibilityContracts[5], implementedGoCompatibilityContracts[6], implementedGoCompatibilityContracts[94]},
	"task-results.test":                   {implementedGoCompatibilityContracts[53]},
	"conversion-discard.test":             {implementedGoCompatibilityContracts[0]},
	"assignment-upcast.test":              {implementedGoCompatibilityContracts[49], implementedGoCompatibilityContracts[76]},
	"callback-results.test":               {implementedGoCompatibilityContracts[29]},
	"named-collection-inference.test":     {implementedGoCompatibilityContracts[29]},
	...
	"local-arrow-groups.test":             {implementedGoCompatibilityContracts[0], implementedGoCompatibilityContracts[1], implementedGoCompatibilityContracts[2]},
	"local-arrow-inference.test":          {implementedGoCompatibilityContracts[0], implementedGoCompatibilityContracts[1], implementedGoCompatibilityContracts[2]},
	"recursive-loop-arrows.test":          {implementedGoCompatibilityContracts[0], implementedGoCompatibilityContracts[1], implementedGoCompatibilityContracts[2]},
	"result-function-values.test":         {implementedGoCompatibilityContracts[0], implementedGoCompatibilityContracts[1], implementedGoCompatibilityContracts[2], implementedGoCompatibilityContracts[16]},
	"generic-callbacks.test":              {implementedGoCompatibilityContracts[0], implementedGoCompatibilityContracts[1], implementedGoCompatibilityContracts[2]},
	...
	"module-main.test":                    {implementedGoCompatibilityContracts[1], implementedGoCompatibilityContracts[2], implementedGoCompatibilityContracts[4]},
	...
	"emitted-name-hygiene.test":           {implementedGoCompatibilityContracts[4], implementedGoCompatibilityContracts[32]},
	...
	"ordered-fields.test":                 {implementedGoCompatibilityContracts[88]},
	"inherited-fields.test":               {implementedGoCompatibilityContracts[88]},
