...
var implementedGoCompatibilityContracts = []string{
	...
	"static class fields with explicit initialization, shared generic and inherited storage, visibility, addressability, package dependency order, module lexical scope, linked aliases, collection and callable values, narrow updates, instance serialization isolation, and public Go variables",
}
