...
var implementedGoCompatibilityContracts = []string{
	...
	"class field initializers with per-instance evaluation, source order, checked reads of earlier initialized fields, base-before-derived phases, generic types and upcasts, module lexical scope, independent reference state, constructor guarantees, exceptions, and public Go construction",
