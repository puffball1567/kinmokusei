...
func TestArrowBindingsPipeline(t *testing.T) {
	...
	for _, input := range []string{
		...
		`const main=():void=>{};`,
		`const main=()=>{};`,
		`const main=()=>{const main=123;};`,
		`const main=()=>{let main="text";main="changed";};`,
		`const main=()=>{const main=(n:int):int=>n+1;main(1);};`,
		`function f(main:int):int{let result=main;{const main=2;result+=main;}return result;}`,
