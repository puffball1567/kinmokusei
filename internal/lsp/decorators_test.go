...
`
	...
	for _, field := range []string{"kind", "identity", "classIdentity", "baseIdentity", "overrideChain", "className", "memberName", "parameterName", "parameterIndex", "static", "visibility", "valueType", "valueIdentity", "constructible", "constructUnavailableReason", "construct", "invocable", "invokeUnavailableReason", "invoke", "staticInvocable", "staticInvokeUnavailableReason", "invokeStatic"} {
		if items[field] == nil {
