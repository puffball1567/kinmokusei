...
| 10 | Source-declared multiple results | Implemented for `(T, U)` signatures on functions, methods, arrows and function types, explicit returns, forwarding, contextual callbacks, arrow result inference and try/catch/finally; named results remain |
