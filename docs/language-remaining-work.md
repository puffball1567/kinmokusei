...
| 10 | Source-declared multiple results | Partially implemented: `(T, U)` signatures on functions, methods, arrows and function types; explicit comma-separated returns, direct call forwarding and contextual callbacks supported; exception lowering remains |
